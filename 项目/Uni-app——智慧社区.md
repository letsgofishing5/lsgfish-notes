...
在Hbuilder X中，找到项目，在项目中找到manifest.json文件，点击，

![image-20210429103218178](Uni-app——智慧社区/image-20210429103218178.png)

填写微信小程序`App ID`后，即可在微信开发者工具中上传

微信小程序`App ID`获取，登录**微信公众平台**，在**开发模块**中找到**开发设置**，里面有`App ID`，粘贴填写即可

#### 配置服务器域名

还是在微信公众平台，开发模块下的开发设置，找到服务器域名，点击修改
